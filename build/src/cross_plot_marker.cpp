...
CrossPlotMarker::CrossPlotMarker(QwtText markerLabel, QPointF point)
	: AbstractPlotMarker(markerLabel, point, QwtPlotMarker::Cross) {
...
void CrossPlotMarker::set_color(QColor color) {
...
void CrossPlotMarker::set_label(QwtText label) {
...
void CrossPlotMarker::set_label_font(QFont font) {
...
void CrossPlotMarker::move(QPointF moveTo) {
